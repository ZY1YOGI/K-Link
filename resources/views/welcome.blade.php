...
@section('content')
    <header>
        <div class="icon">
            <a href="{{ route('auth') }}"><i id="sign" class="fa-solid fa-user-plus"></i></a>
        ...
        <div class="logo">
            <a href=""> {{ env('APP_NAME') }} <i class="fa-solid fa-graduation-cap"></i></a>
        </div>
    </header>
    <!-- HOME START -->
    <section class="home" id="home">
        <div class="content">
            ...
            <a href="{{ route('auth') }}" class="btn">سجل الأن</a>
        </div>
    </section>
    <!-- HOME END -->
    ...
    <section class="section2">
        ...
        <div class="container" id="events">
            <div class="box">
                <div class="img">
                    <img src="{{ Vite::asset('resources/img/bg_logo.jpg') }}" alt="">
                </div>
                <div class="text">
            ...
            <div class="box">
                <div class="img">
                    <img class="img_hr" src="{{ Vite::asset('resources/img/bg_hr_2.jpg') }}" alt="">
                </div>
                <div class="text">
            ...
            <div class="box">
                <div class="img">
                    <img src="{{ Vite::asset('resources/img/gathered.jpg') }}" alt="">
                </div>
                <div class="text">
            ...
            <div class="box">
                <div class="img">
                    <img src="{{ Vite::asset('resources/img/distribution_of_certificates.jpg') }}" alt="">
                </div>
                <div class="text">
    ...
    <footer>
        <h1>جميع الحقوق محفوظه لي مدارس الكمال ترند لينك &copy; {{ now()->year }} | 2019</h1>
    </footer>
@endsection
